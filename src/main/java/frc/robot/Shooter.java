...
public class Shooter {
    ...
    public Shooter(Servo hoodServoIN, TalonSRX turret775IN, CANEncoder flywheelEncoderIN,
            CANPIDController flywheelPIDControllerIN, CANSparkMax flywheelNeo1IN, XboxController eeControllerIN,
            int flywheelRPMIN, double flywheelSpeedIN, double turretPosRobot) {
